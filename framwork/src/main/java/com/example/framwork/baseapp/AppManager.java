...
//            e.printStackTrace();
     ...
     * 结束所有Activity
     */
    public void finishAllActivity(Class activity) {
        Stack<AppCompatActivity> activities = activityStack;
        for (int i = activities.size() - 1; i >= 0; i--) {
            if (null != activities.get(i) && !activities.get(i).getClass().equals(activity)) {
