...
public class AndroidBug5497Workaround {
    ...
    private AndroidBug5497Workaround(final AppCompatActivity activity) {
     ...
     */
    private static boolean checkDeviceHasNavigationBar(AppCompatActivity activity) {
     ...
     * @return 是否有NavigationBar
     */
    private static boolean hasNavBar(AppCompatActivity activity) {
