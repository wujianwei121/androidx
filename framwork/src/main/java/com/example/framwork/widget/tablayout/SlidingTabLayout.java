package com.example.framwork.widget.tablayout;
...
import com.example.framwork.widget.tablayout.utils.UnreadMsgUtils;
import com.example.framwork.widget.tablayout.widget.MsgView;
    ...
    private void updateTabStyles() {
        for (int i = 0; i < mTabCount; i++) {
            ...
            if (tv_tab_title != null) {
                ...
                tv_tab_title.setTextSize(TypedValue.COMPLEX_UNIT_PX, i == mCurrentTab && mTextSelectSize != 0 ? mTextSelectSize : mTextsize);
                tv_tab_title.setPadding((int) mTabPadding, 0, (int) mTabPadding, 0);
                if (mTextBold == TEXT_BOLD_BOTH) {
                    tv_tab_title.setTypeface(Typeface.defaultFromStyle(Typeface.BOLD));//加粗
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            if (tab_title != null) {
                ...
                tab_title.setTextSize(TypedValue.COMPLEX_UNIT_PX, isSelect && mTextSelectSize != 0 ? mTextSelectSize : mTextsize);
                if (mTextBold == TEXT_BOLD_WHEN_SELECT) {
                    if (isSelect) {
                        tab_title.setTypeface(Typeface.defaultFromStyle(Typeface.BOLD));//加粗
                    } else tab_title.setTypeface(Typeface.defaultFromStyle(Typeface.NORMAL));//加粗
                }
            }
        }
    }
