...
public class LoadDataLayout extends FrameLayout implements View.OnClickListener {
    ...
    public final static int NO_Login = 15;
    ...
    private void build() {
        ...
        errorLayout = errorView.findViewById(R.id.error_layout);
        noNetWorkLayout = noNetworkView.findViewById(R.id.no_network_layout);

        emptyImg = emptyView.findViewById(R.id.empty_img);
        errorImg = errorView.findViewById(R.id.error_img);
        noNetworkImg = noNetworkView.findViewById(R.id.no_network_img);

        loadingTv = loadingView.findViewById(R.id.loading_text);
        emptyTv = emptyView.findViewById(R.id.empty_text);
        errorTv = errorView.findViewById(R.id.error_text);
        noNetworkTv = noNetworkView.findViewById(R.id.no_network_text);

        emptyReloadBtn = emptyView.findViewById(R.id.empty_reload_btn);
        errorReloadBtn = errorView.findViewById(R.id.error_reload_btn);
        noNetWorkReloadBtn = noNetworkView.findViewById(R.id.no_network_reload_btn);
    ...
    public LoadDataLayout setErrorBtnTextColor(@NonNull int color) {
        errorReloadBtn.setTextColor(ContextCompat.getColor(mContext, color));
        return this;
    }
    ...
    public LoadDataLayout setErrorBtnBg(@DrawableRes int resId) {
        if (resId != 0)
            errorReloadBtn.setBackgroundResource(resId);
        return this;
    }
    ...
    public LoadDataLayout setAllPageBackgroundColor(int colorId) {
        loadingView.setBackgroundResource(colorId);
        emptyView.setBackgroundResource(colorId);
        errorView.setBackgroundResource(colorId);
        noNetworkView.setBackgroundResource(colorId);
        return this;
    }
    ...
    public static class Builder {
        ...
        int emptyImgId = R.drawable.ic_eew;
        int errorImgId = R.drawable.ic_eew;
        int noNetWorkImgId = R.drawable.ic_eew;
        ...
        int allPageBackgroundColor = R.color.transparent;
        int allTipTextColor = R.color.gray_98;
        int allTipTextSize = 16;
        int loadingTextSize = 16;
        int loadingTextColor = R.color.gray_98;
        int reloadBtnTextSize = 14;
        int reloadBtnTextColor = R.color.gray_98;
