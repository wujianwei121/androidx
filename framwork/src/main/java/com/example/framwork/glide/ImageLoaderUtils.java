...
public class ImageLoaderUtils {
    ...
    public static void displayfit(Context context, ImageView imageView, String url, int error) {
        if (imageView == null) {
            throw new IllegalArgumentException("argument error");
        }
        displayfit(context, imageView, url, 0, error);
    }

    public static void displayfit(Context context, ImageView imageView, String url, ColorDrawable error) {
        if (imageView == null) {
            throw new IllegalArgumentException("argument error");
        }
        if (url == null || TextUtils.isEmpty(url)) {
